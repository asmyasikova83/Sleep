...
The code for  automatic sleep staging identification, plotting hypnograms and spectrograms, assessing YASA classification, deriving sleep statistics and creating PDF reports for the mentioned data(https://doi.org/10.13026/t4w7-3k21):
